          ...
          <div className="content">
              ...
              <div className="collection-list">
                  <a className="collection-item" href="collection.html" style={{"background": "#d9d9d9"}}>
                      ...
                      <div className="overlay fake-btn hidden" aria-hidden="true" style={{"background": "#4d4d4d"}}>Shop <span className="hide-content">our {category.name} collection </span>now</div>
                  </a>
                  <a className="collection-item" href="collection.html" style={{"background": "#d7f0ea"}}>
                      ...
                      <div className="overlay fake-btn hidden" aria-hidden="true" style={{"background": "#5d8077"}}>Shop <span className="hide-content">our {category.name} collection </span>now</div>
                  </a>
                  <a className="collection-item" href="collection.html" style={{"background": "#ded7cb"}}>
                      ...
                      <div className="overlay fake-btn hidden" aria-hidden="true" style={{"background": "#4d4841"}}>Shop <span className="hide-content">our {category.name} collection </span>now</div>
                  </a>
                  <a className="collection-item" href="collection.html" style={{"background": "#e6e1e1"}}>
                      ...
                      <div className="overlay fake-btn hidden" aria-hidden="true" style={{"background": "#666363"}}>Shop <span className="hide-content">our {category.name} collection </span>now</div>
                  </a>
              </div>
          </div>
      </div>
